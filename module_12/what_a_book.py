...
def validate_user():    # method that validates user
    try:
...
def show_books_to_add(_cursor, _user_id):    # method that shows the user what books are available to add to the wishlist
    ...
    books_not_in_wishlist = ("SELECT book_id, book_name, author, details" +
                            " FROM book"+
    ...
    print("\n <<<< SHOWING BOOKS AVAILABLE TO AT TO WISHLIST >>>> ")
